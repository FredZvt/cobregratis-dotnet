...
namespace ConsoleSandBox
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            CobreGratis.CreateBankBillet(1, 123.45M, DateTime.Now.AddDays(10), "Sacado da Silva");
            CobreGratis.CreateBankBillet(1, 123.45M, DateTime.Now.AddDays(10), "Sacado da Silva", "description", "instructions", "cnpjCpf", "address", "zipcode", "neighborhood", "city", "state", "docNumber", 10.0M, 10.0M, 10.0M, 10.0M, "comments");
